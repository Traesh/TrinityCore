...
namespace WorldPackets
{
    namespace Scenario
    {
        ...
        public:
            ...
            std::vector<BonusObjectiveData> AvailableObjectives;
            std::vector<uint32> TraversedSteps;
            std::vector<BonusObjectiveData> CompletedObjectives;
        ...
        {
        public:
            ScenarioCompleted() : ScenarioId(), ServerPacket(SMSG_SCENARIO_COMPLETED, 4) { }
