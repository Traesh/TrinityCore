...
class TC_GAME_API Scenario : public CriteriaHandler
{
    public:
        ...
        void Reset() override;
        void SetStepByIndex(uint8 newStepIndex);
        void SetStep(ScenarioStepEntry const* step);
        void SetNextStep() { SetStepByIndex(++_currentStepIndex); }
        ...
        void SendScenarioState(Player* player, bool initial = false, bool remove = false);
    ...
    protected:
        ...
        void BuildScenarioState(WorldPackets::Scenario::ScenarioState* scenarioState, bool initial = false, bool remove = false);
